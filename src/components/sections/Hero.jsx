...
const Hero = () => {
    ...
    return (
      <section className="relative min-h-screen pt-32 pb-20 overflow-hidden bg-slate-50 dark:bg-slate-950 flex items-center">
        {/* Floating Orbs Layer */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-8 items-center">
            ...
            <RevealOnScroll direction="up" className="max-w-2xl">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-teal-600 dark:text-teal-400 text-sm font-semibold mb-8 shadow-sm">
              ...
              <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-[5rem] font-bold text-slate-950 dark:text-white tracking-tighter leading-[1.05] mb-8">
                Precision health, <br />
              ...
              <p className="text-lg lg:text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed font-light max-w-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Button variant="glass" className="text-lg dark:bg-white/5 dark:text-white dark:border-white/10">
                  Explore Pharmacy
                </Button>
              </div>
            ...
            {/* Hero Visuals - Parallax Layer */}
            <div 
                className="relative h-[600px] hidden lg:block perspective-1000 transition-transform duration-100 ease-out"
                style={{ transform: `translateY(${scrollOffset * 0.15}px)` }}
            >
              {/* Main Image Plate */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[500px] rounded-[2.5rem] overflow-hidden border border-slate-200/50 dark:border-white/10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] z-10 animate-float">
              ...
              <div 
                className="absolute top-[20%] left-[0%] z-20 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border border-slate-100 dark:border-white/5 p-5 rounded-2xl shadow-xl animate-float-delayed w-64"
              ...
              <div 
                className="absolute bottom-[20%] right-[-10%] z-30 bg-white dark:bg-slate-900 p-5 rounded-2xl shadow-xl border border-slate-100 dark:border-white/5 animate-float w-72"
                style={{ transform: `translateY(${scrollOffset * -0.08}px)` }}
              >
                <div className="flex items-start gap-4">
                  <div className="bg-slate-900 dark:bg-white text-white dark:text-slate-900 p-3 rounded-xl shadow-md">
                    <Truck size={24} />
                  </div>
                  <div>
                    <p className="text-sm font-bold text-slate-900 dark:text-white mb-1">Out for delivery</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">Arriving by 4:00 PM</p>
        ...
        <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-slate-50 dark:from-slate-950 to-transparent pointer-events-none z-20"></div>
      </section>
    );
  };
